...
const Login = () => {
  ...
  return (
    <>
        <div className="w-full h-screen relative lg:mt-32 py-4">
            <div className="mx-auto flex max-w-sm overflow-hidden rounded-lg bg-white shadow-lg lg:max-w-4xl">
                ...
                <a href="#" className="mt-4 flex items-center justify-center rounded-lg text-white shadow-md hover:bg-gray-100">
                    ...
                    <h1 className="w-5/6 px-4 py-3 text-center font-bold text-gray-600">Sign in with Google</h1>
                </a>
                ...
                <div className="mt-4 flex items-center justify-between">
                    ...
                    <a href="/signup" className="text-md font-bold uppercase text-gray-500">or sign up</a>
                    <span className="w-1/5 border-b md:w-1/4"></span>
                </div>
                </div>
            </div>
