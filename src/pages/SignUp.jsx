        ...
        <div className="w-full h-screen relative lg:mt-20">
            <div className="mx-auto flex max-w-sm overflow-hidden rounded-lg bg-white shadow-lg lg:max-w-4xl">
                ...
                <div className="mt-4">
                    ...
                    <input className="focus:shadow-outline block w-full appearance-none rounded border border-gray-300 bg-gray-200 px-4 py-2 text-gray-700 focus:outline-none" type="text" />
                </div>
                <div className="mt-4">
                ...
                <div className="mt-8">
                    <button className="w-full rounded bg-gray-700 px-4 py-2 font-bold text-white hover:bg-gray-600">Register</button>
                </div>
                </div>
            </div>
        </div>
