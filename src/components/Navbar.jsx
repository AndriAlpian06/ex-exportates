...
const Navbar = () => {
  ...
  return (
    <div className={color ? 'fixed top-0 left-0 right-0 w-full bg-white z-10 border-b-green-500' : 'lg:top-10 sm:top-10 left-0 right-0 bg-white border-b-green-500 rounded-md w-9/12 mx-auto absolute z-10'}>
        <MobileNavbar />
